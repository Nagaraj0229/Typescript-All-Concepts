...
import { RefreshTokenRequest, RefreshTokenResponse } from '../crm/aw-hubspot/interfaces/auth';
...
export interface AuthService {
  ...
  tokenInfo(token: string): Promise<RefreshTokenResponse | undefined>;
}
...
export interface ContactService {
  ...
  getAll<O>(
    ...
    properties: string[],
    associations: string[]
  ): Promise<PagingType<O> | undefined>;
